    ...
    "missions": [
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_pedir_claridad_sobre_familiar_friendly",
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_mencionar_limite_vestuario_y_reemplazo",
            "text": "Señalar en inglés que tu vestuario limita un salto específico y ofrecer un reemplazo creíble."
          },
          {
            "requirementId": "conversation_solicitar_demostracion_acento_movimiento",
          ...
          {
            "requirementId": "conversation_agradecer_critica_y_pedir_ajuste_accionable",
    ...
    "missions": [
      {
        ...
        "sceneSummary": "Encuentras a un relojero excéntrico rodeado de engranajes y relojes que marcan horas distintas; parece haber perdido la llave maestra. Debes negociar pistas antes de que un reloj empiece a sonar a las doce equivocada.",
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_request_final_confirmation_before_action",
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_reaccionar_truco_con_escepticismo_cortesia",
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_formular_pregunta_cerrada_origen_pista",
          ...
          {
            "requirementId": "conversation_explicar_por_que_interpretacion_fallida",
          ...
          {
            "requirementId": "conversation_pedir_tonalidad_distinta_para_distinguir",
            "text": "Pide que cante una estrofa en una tonalidad distinta para distinguir palabras similares."
          },
          {
            "requirementId": "conversation_confirmar_secuencia_acciones_estribillo",
          ...
          {
            "requirementId": "conversation_probar_combinacion_y_reportar_resultado",
          ...
          {
            "requirementId": "conversation_validar_con_beatrice_objetivo_inmediato",
          ...
          {
            "requirementId": "conversation_pedir_confirmacion_final_accion_riesgosa",
            "text": "Pide confirmación final antes de accionar una palanca o mecanismo mencionado en la canción."
          },
          {
            "requirementId": "conversation_preguntar_si_cambio_estrofa_reinicia_pista",
    ...
    "missions": [
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_reaccion_sorprendida_pregunta_seguimiento",
    ...
    "missions": [
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_preguntar_objetos_extraviados_recientes",
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_marcar_limites_sobre_prop_del_telefono",
    ...
    "missions": [
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_negociar_compensacion_olor_persistente",
      ...
      },
      {
        ...
        "requirements": [
          {
            "requirementId": "conversation_identificar_preferencias_decoracion_fantasma",
          ...
          {
            "requirementId": "conversation_consultar_preferencias_colores_fantasma",
      ...
      },
      {
        ...
        "requirements": [
          {
            "requirementId": "conversation_greet_parrot_formally",
            "text": "Saluda formalmente al loro como si fuera profesor y verifica si prefiere que lo llamen 'Professor' u otro título."
          },
          {
            "requirementId": "conversation_request_demo_correction",
            "text": "Pide una demostración corta en la que el loro corrija una palabra difícil y confirma que entendiste la corrección."
          },
          {
            "requirementId": "conversation_negotiate_class_schedule",
            "text": "Negocia un horario específico para las 'clases' del loro que no interfiera con tus reuniones."
          },
          {
            "requirementId": "conversation_set_quiet_hours",
            "text": "Establece horas de silencio en la sala y consigue el acuerdo explícito del compañero."
          },
          {
            "requirementId": "conversation_ask_reason_academic_accent",
            "text": "Pregunta por qué el loro tiene acento académico y pide un ejemplo de ese acento."
          },
          {
            "requirementId": "conversation_state_boundaries_room",
            "text": "Aclara que el loro no debe entrar a tu dormitorio y solicita confirmación de que respetarán ese límite."
          },
          {
            "requirementId": "conversation_request_repeat_minimal_pair",
            "text": "Pide al loro repetir un par mínimo (por ejemplo, ship/sheep) y confirma cuál suena correcto."
          },
          {
            "requirementId": "conversation_react_to_interruption",
            "text": "Reacciona con cortesía cuando el loro te interrumpa y solicita turno para terminar tu frase."
          },
          {
            "requirementId": "conversation_ask_volume_control",
            "text": "Pregunta si pueden controlar el volumen del loro y acuerda un nivel aceptable para ambos."
          },
          {
            "requirementId": "conversation_request_hand_signal",
            "text": "Propón una señal de mano para indicar pausa durante las correcciones y verifica que la usarán."
          },
          {
            "requirementId": "conversation_confirm_cleaning_duties",
            "text": "Confirma quién limpiará las plumas y restos del loro en la sala y cuándo lo harán."
          },
          {
            "requirementId": "conversation_ask_feed_time_limit",
            "text": "Pregunta a qué horas alimentan al loro y pide evitar hacerlo durante tus llamadas."
          },
          {
            "requirementId": "conversation_propose_trial_week",
            "text": "Propón una semana de prueba para las 'clases' y acuerda criterios para evaluar si funcionan."
          },
          {
            "requirementId": "conversation_request_polite_corrections",
            "text": "Solicita que las correcciones del loro se formulen de manera breve y educada, y verifica un ejemplo."
          },
          {
            "requirementId": "conversation_check_allergy_concerns",
            "text": "Pregunta si el loro suelta polvo o caspa y acuerda ventilar o usar purificador cuando sea necesario."
          },
          {
            "requirementId": "conversation_seek_permission_record",
            "text": "Pide permiso para grabar una corrección breve del loro para practicar más tarde."
          },
          {
            "requirementId": "conversation_ask_trigger_words",
            "text": "Pregunta si hay palabras o sonidos que exciten al loro y acuerda evitarlos en la noche."
          },
          {
            "requirementId": "conversation_request_example_linking",
            "text": "Pide un ejemplo de 'linking' o unión de palabras y repite hasta que el loro te apruebe."
          },
          {
            "requirementId": "conversation_express_empathy_noise",
            "text": "Expresa empatía por el entusiasmo del loro, pero explica cómo el ruido te afecta y busca una solución conjunta."
          },
          {
            "requirementId": "conversation_offer_compromise_location",
            "text": "Ofrece mover las 'clases' a la mesa del comedor en lugar de la sala si hay visitas, y consigue acuerdo."
          },
          {
            "requirementId": "conversation_clarify_correction_frequency",
            "text": "Aclara cuántas correcciones por minuto consideras razonables y acuerda un máximo."
          },
          {
            "requirementId": "conversation_request_end_signal",
            "text": "Pide una frase de cierre del loro para indicar fin de clase y acepta una propuesta concreta."
          },
          {
            "requirementId": "conversation_share_learning_goal",
            "text": "Comparte tu objetivo de pronunciación para hoy y pide al loro que se enfoque solo en ese objetivo."
          },
          {
            "requirementId": "conversation_reject_unwanted_topic_politely",
            "text": "Rechaza con educación un tema de corrección que no te interesa y redirige a otro más útil."
          },
          {
            "requirementId": "conversation_confirm_guest_policy",
            "text": "Confirma la política de visitas cuando el loro está dando 'clase' y acuerda avisos previos."
          },
          {
            "requirementId": "english_use_discourse_marker_frankly",
            "text": "Usa 'Frankly,' al introducir tu preocupación por el ruido académico del loro."
          },
          {
            "requirementId": "english_use_collocation_set_ground_rules",
            "text": "Usa la colocation 'set some ground rules' para proponer normas de convivencia durante las correcciones."
          },
          {
            "requirementId": "english_use_phrasal_turn_down",
            "text": "Usa el phrasal verb 'turn down' para pedir que bajen el volumen del loro."
          },
          {
            "requirementId": "english_use_idiom_elephant_in_the_room",
            "text": "Usa el idiom 'the elephant in the room' para introducir el tema de las interrupciones del loro."
          },
          {
            "requirementId": "english_use_collocation_pronunciation_drill",
            "text": "Incluye la expresión 'pronunciation drill' al pedir un ejercicio breve."
          },
          {
            "requirementId": "english_use_phrasal_work_out_plan",
            "text": "Usa 'work out' para proponer que elaboren un plan de horarios con el loro."
          },
          {
            "requirementId": "english_use_idiom_on_the_same_page",
            "text": "Usa 'on the same page' para verificar si están de acuerdo con el límite de correcciones."
          },
          {
            "requirementId": "english_use_advanced_lexis_intrusive",
            "text": "Incluye la palabra 'intrusive' para describir cuándo las correcciones resultan demasiado invasivas."
          },
          {
            "requirementId": "english_use_phrasal_put_up_with",
            "text": "Usa 'put up with' para explicar cuánto ruido estás dispuesto a tolerar."
          },
          {
            "requirementId": "english_use_collocation_strict_schedule",
            "text": "Emplea 'a strict schedule' para hablar de un calendario fijo de 'clases'."
          },
          {
            "requirementId": "english_use_idiom_hit_the_nail",
            "text": "Usa 'hit the nail on the head' para elogiar una corrección muy acertada del loro."
          },
          {
            "requirementId": "english_use_linking_phrase_that_said",
            "text": "Incluye 'That said,' para matizar una crítica con un comentario positivo."
          },
          {
            "requirementId": "english_use_phrasal_bring_up",
            "text": "Usa 'bring up' para introducir el tema de no entrar al dormitorio."
          },
          {
            "requirementId": "english_use_collocation_noise_level",
            "text": "Menciona 'acceptable noise level' al acordar el volumen de las 'clases'."
          },
          {
            "requirementId": "english_use_idiom_break_the_ice",
            "text": "Usa 'break the ice' para proponer un warm-up al inicio de la corrección."
          },
          {
            "requirementId": "english_use_phrasal_point_out",
            "text": "Usa 'point out' para pedir que el loro señale dónde falló tu entonación."
          },
          {
            "requirementId": "english_use_collocation_constructive_feedback",
            "text": "Incluye 'constructive feedback' al solicitar retroalimentación específica."
          },
          {
            "requirementId": "english_use_idiom_by_the_book",
            "text": "Usa 'by the book' para describir el estilo académico del loro."
          },
          {
            "requirementId": "english_use_phrasal_iron_out",
            "text": "Usa 'iron out' para sugerir que pulan detalles del acuerdo de convivencia."
          },
          {
          ...
          {
            "requirementId": "english_use_idiom_at_the_end_of_the_day",
            "text": "Usa 'at the end of the day' para resumir tu posición sobre las correcciones."
          },
          {
            "requirementId": "english_use_phrasal_carry_on_practice",
            "text": "Usa 'carry on' para pedir que sigan con el ejercicio tras una pausa."
          },
          {
            "requirementId": "english_use_collocation_gentle_reminder",
            "text": "Incluye 'a gentle reminder' para recordar el límite de tiempo de la 'clase'."
          },
          {
            "requirementId": "english_use_phrasal_back_down",
            "text": "Usa 'back down' para pedir que el loro ceda cuando haya desacuerdo sobre tu acento."
          },
          {
            "requirementId": "english_use_idiom_feather_in_your_cap",
            "text": "Usa 'a feather in your cap' para elogiar una mejora notable en tu pronunciación gracias al loro."
          }
        ]
      },
      {
        ...
        "requirements": [
          {
            "requirementId": "conversation_clarify_not_moving_out",
            "text": "Aclara explícitamente en inglés que no te vas del departamento y verifica que Rafa lo haya entendido."
          },
          {
            "requirementId": "conversation_ask_who_invited",
            "text": "Pregunta en inglés quién invitó a cada invitado peculiar y con qué criterio."
          },
          {
            "requirementId": "conversation_check_guest_list_limit",
            "text": "Negocia en inglés un límite concreto de personas en la lista de invitados para que te sientas cómodo."
          },
          {
            "requirementId": "conversation_request_noise_boundaries",
            "text": "Establece en inglés un horario de silencio o un nivel máximo de ruido aceptable."
          },
          {
            "requirementId": "conversation_ask_budget_source",
            "text": "Pregunta en inglés de dónde salió el presupuesto de la fiesta y si habrá gastos compartidos."
          },
          {
          ...
          },
          {
            ...
            "text": "Pide en inglés que no entren a tu habitación y confirma que Rafa lo comunicará a todos."
          },
          {
            "requirementId": "conversation_address_weird_gift",
            "text": "Pregunta en inglés por qué hay regalos de despedida y sugiere qué hacer con ellos."
          },
          {
            "requirementId": "conversation_manage_emotions",
            "text": "Expresa en inglés cómo te sientes con la confusión y valida la buena intención de Rafa."
          },
          {
            "requirementId": "conversation_request_clear_announcement",
            "text": "Pide en inglés que Rafa haga un anuncio claro explicando que no te mudas."
          },
          {
            "requirementId": "conversation_set_food_allergies",
            "text": "Informa en inglés de cualquier alergia o preferencia alimentaria y confirma que se respetará."
          },
          {
            "requirementId": "conversation_handle_uninvited_person",
            "text": "Pregunta en inglés por una persona que no conoces y decide si puede quedarse o debe irse."
          },
          {
            "requirementId": "conversation_propose_activity_switch",
            "text": "Sugiere en inglés cambiar una actividad planeada por otra que encaje con la situación real."
          },
          {
            "requirementId": "conversation_negotiate_music_volume",
            "text": "Negocia en inglés el volumen de la música y acuerda un ajuste concreto."
          },
          {
            "requirementId": "conversation_seek_clarification_on_theme_signs",
            "text": "Pide en inglés que Rafa explique los letreros y decoraciones raras y su significado."
          },
          {
            "requirementId": "conversation_timeframe_agreement",
            "text": "Acordar en inglés una hora específica para terminar la fiesta y confírmalo con Rafa."
          },
          {
            "requirementId": "conversation_request_cleanup_plan",
            "text": "Exige en inglés un plan de limpieza posterior y quién se encargará de cada tarea."
          },
          {
            "requirementId": "conversation_decline_embarrassing_speech",
            "text": "Rechaza en inglés dar un discurso de despedida incómodo y ofrece una alternativa breve."
          },
          {
            "requirementId": "conversation_invite_neighbor_check",
            "text": "Pregunta en inglés si avisaron a los vecinos y sugiere una acción para evitar quejas."
          },
          {
            "requirementId": "conversation_test_rafa_story_consistency",
            "text": "Pide en inglés una versión coherente de la explicación de Rafa sobre por qué creyó que te ibas."
          },
          {
            "requirementId": "conversation_ask_for_private_moment",
            "text": "Solicita en inglés un momento a solas con Rafa para resolver la confusión sin público."
          },
          {
            "requirementId": "conversation_propose_shared_toast_message",
            "text": "Propón en inglés un brindis que celebre la amistad y aclare la falsa despedida."
          },
          {
            "requirementId": "conversation_set_photo_boundaries",
            "text": "Establece en inglés límites sobre fotos o redes sociales y qué se puede publicar."
          },
          {
            "requirementId": "conversation_confirm_safety_details",
            "text": "Verifica en inglés detalles de seguridad como salidas despejadas y velas supervisadas."
          },
          {
            "requirementId": "conversation_decide_keep_or_cancel",
            "text": "Decide en inglés si mantener la fiesta con cambios o cancelarla, y comunica la decisión con cortesía."
          },
          {
            "requirementId": "english_use_spill_the_beans",
            "text": "Usa la expresión en inglés 'spill the beans' para pedir que alguien revele quién inició el rumor de tu mudanza."
          },
          {
            "requirementId": "english_use_guest_list_collocation",
            "text": "Usa la collocation en inglés 'guest list' para preguntar si tu nombre figuraba y quién más está apuntado."
          },
          {
            "requirementId": "english_use_set_up_phrasal",
            "text": "Usa el phrasal verb en inglés 'set up' para hablar de quién montó la decoración y en cuánto tiempo."
          },
          {
            "requirementId": "english_use_pull_off_idiom",
            "text": "Usa la expresión en inglés 'pull off' para evaluar si Rafa puede salvar la fiesta a pesar del malentendido."
          },
          {
          ...
          {
            "requirementId": "english_use_last_minute_collocation",
            "text": "Usa la collocation en inglés 'last-minute changes' para proponer ajustes urgentes."
          },
          {
            "requirementId": "english_use_turn_down_phrasal",
            "text": "Usa el phrasal verb en inglés 'turn down' para rechazar una actividad de la fiesta con una razón."
          },
          {
            "requirementId": "english_use_break_the_ice_idiom",
            "text": "Usa la expresión en inglés 'break the ice' para sugerir una dinámica corta al inicio."
          },
          {
            "requirementId": "english_use_run_out_of_phrasal",
            "text": "Usa el phrasal verb en inglés 'run out of' para advertir sobre la escasez de comida o vasos."
          },
          {
            "requirementId": "english_use_spare_keys_collocation",
            "text": "Usa la collocation en inglés 'spare keys' para preguntar cómo entró alguien inesperado."
          },
          {
            "requirementId": "english_use_sort_out_phrasal",
            "text": "Usa el phrasal verb en inglés 'sort out' para proponer resolver la confusión antes de que lleguen más invitados."
          },
          {
            "requirementId": "english_use_elephant_in_the_room_idiom",
            "text": "Usa la expresión en inglés 'the elephant in the room' para abordar directamente que no te vas."
          },
          {
            "requirementId": "english_use_cater_for_collocation",
            "text": "Usa la collocation en inglés 'cater for dietary needs' para comprobar si se consideraron alergias."
          },
          {
            "requirementId": "english_use_frankly_discourse_marker",
            "text": "Usa el marcador discursivo en inglés 'frankly' para introducir una opinión honesta sobre la fiesta."
          },
          {
            "requirementId": "english_use_crash_the_party_idiom",
            "text": "Usa la expresión en inglés 'crash the party' para hablar de alguien que vino sin invitación."
          },
          {
            "requirementId": "english_use_show_of_hands_collocation",
            "text": "Usa la collocation en inglés 'a show of hands' para proponer una decisión rápida con los invitados."
          },
          {
            "requirementId": "english_use_follow_up_phrasal",
            "text": "Usa el phrasal verb en inglés 'follow up' para pedir confirmación posterior sobre el plan de limpieza."
          },
          {
            "requirementId": "english_use_wind_down_phrasal",
            "text": "Usa el phrasal verb en inglés 'wind down' para acordar cómo finalizar la fiesta de forma tranquila."
          },
          {
            "requirementId": "english_use_spot_on_idiom",
            "text": "Usa la expresión en inglés 'spot on' para elogiar una idea que encaje perfectamente con la nueva realidad."
          },
          {
            "requirementId": "english_use_short_notice_collocation",
            "text": "Usa la collocation en inglés 'at such short notice' para agradecer el esfuerzo de organización repentina."
          },
          {
            "requirementId": "english_use_make_it_up_to_you_phrase",
            "text": "Usa la frase en inglés 'make it up to you' para proponer cómo compensar la confusión."
          },
          {
            "requirementId": "english_use_mix_up_noun_phrasal",
            "text": "Usa el sustantivo en inglés 'mix-up' para nombrar el malentendido sobre tu supuesta mudanza."
          },
          {
            "requirementId": "english_use_keep_it_low_key_idiom",
            "text": "Usa la expresión en inglés 'keep it low-key' para sugerir una versión más tranquila del evento."
          }
        ]
      }
    ]
  },
  {
    ...
    "missions": [
      ...
      },
      {
        ...
        "requirements": [
          {
            "requirementId": "conversation_solicitar_lista_ingredientes_detallada",
          ...
          {
            "requirementId": "conversation_cuestionar_inconsistencia_presentacion",
          ...
          {
            "requirementId": "english_usar_collocation_consistency_across_batches",
      ...
      },
      {
        ...
        "sceneSummary": "Una cajera que hace coreografías te ofrece un descuento si improvisas un breve estribillo sobre la comida.",
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_cambiar_ingrediente_sin_perder_descuento",
    ...
    "missions": [
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_cerrar_rumor_con_conclusion_diplomatica",
      ...
      },
      {
        ...
        "sceneSummary": "Un juez de etiqueta evalúa tu desempeño con tarjetas de colores y comentarios severos. Debes defender una decisión propia con argumentos cortos y educados.",
        "aiRole": "Eres un juez riguroso, con tono crítico y a veces sarcástico, pero justo. Da comentarios concretos, puntúa acciones y espera que el aprendiz razone sus elecciones.",
      ...
      },
      {
        ...
        "sceneSummary": "Tu pareja de baile pisa tus pies y confunde pasos de vals con breakdance. Debes dirigir la pareja con frases claras y mantener el ritmo.",
  ...
  },
  {
    ...
    "missions": [
      ...
      },
      {
        ...
        "sceneSummary": "Un técnico de sonido exageradamente dramático anuncia efectos especiales que nunca llegaron; tienes que negociar y coordinar para que el público no note nada.",
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_reconoce_punto_valido_y_propone_ajuste",
          ...
          {
            "requirementId": "conversation_muestra_empatia_con_confusion_del_publico",
          ...
          {
            "requirementId": "conversation_propone_cambio_medible_para_proxima_entrada",
            "text": "Propón en inglés un cambio medible para tu próxima entrada a escena y define cómo se verificará el resultado."
          },
          {
            "requirementId": "conversation_invita_a_penelope_a_colaborar_un_momento",
      ...
      },
      {
        ...
        "sceneSummary": "Un personaje misterioso aparece en el escenario con pistas raras y un acento extraño; debes interrogarle para descubrir su secreto sin romper el ritmo.",
    ...
    "missions": [
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_hacer_pregunta_sobre_conciencia_maquina",
      ...
      },
      {
        ...
        "sceneSummary": "Un dragón diminuto y parlante propone una actividad de integración que suena peligrosa pero resulta ser ridículamente inofensiva. Debes convencerlo (o negarte) con argumentos razonables.",
  ...
  },
  {
    ...
    "missions": [
      ...
      },
      {
        ...
        "requirements": [
          {
            "requirementId": "conversation_pedir_permiso_tocar_despertador_bronce",
            "text": "Pide permiso explícito para tocar el pequeño despertador de bronce que el poeta está golpeando con el dedo."
          },
          {
            "requirementId": "conversation_preguntar_historia_despertador_antiguo",
          ...
          {
            "requirementId": "conversation_proponer_intercambio_metafora_silencio",
    ...
    "missions": [
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_defender_eleccion_profesional_con_razones",
      ...
      },
      {
        ...
        "requirements": [
          ...
          {
            "requirementId": "conversation_reaccionar_ante_broma_incomoda_con_tacto",
            "text": "Responde a una broma incómoda de un familiar con humor ligero sin desviar la conversación del tema de la comida."
          },
          {
            "requirementId": "conversation_pedir_tiempo_para_oler_o_probar_primero",
          ...
          {
            "requirementId": "conversation_preguntar_por_version_sin_un_ingrediente",
            "text": "Pregunta si existe una versión sin un ingrediente concreto que te inquieta."
          },
          {
            "requirementId": "conversation_proponer_brindis_breve_por_la_anfitriona",
  ...
  },
  {
    ...
    "missions": [
      ...
      },
      {
        ...
        "aiRole": "Eres una estatua humana práctica y formal que usa un lenguaje educado pero con demandas ridículas. Mantén un tono serio a pesar del absurdo; ofrece opciones y espera que el alumno negocie.",
