    ...
    missions: [
      {
        ...
        title: "Pedir un taxi",
        sceneSummary:
          "Habla con un taxista para llegar al hotel cerca del estadio del Arsenal.",
        aiRole:
      ...
      },
      {
        ...
        sceneSummary:
          "Consulta con un guía sobre los paseos en barco por el Támesis.",
        aiRole:
      ...
      },
      {
        ...
        sceneSummary:
          "Su aura es tan brillante que casi necesitas gafas de sol. Habla de energías, chakras y viajes espirituales.",
        aiRole:
        ...
        requirements: [
          {
            requirementId: "ask_name",
            text: "Pregúnta su nombre.",
          },
          {
            requirementId: "ask_age",
            text: "Pregúnta su edad.",
          },
        ],
      },
    ],
  },
  {
    ...
    missions: [
      ...
      },
      {
        ...
        sceneSummary:
          "Parece dulce y simpática… hasta que menciona a su ex por quinta vez en dos minutos.",
        aiRole:
          "Eres una chica simpática pero completamente obsesionada con tu ex. Lo mencionas en cada conversación sin darte cuenta.",
      ...
      },
      {
        ...
        sceneSummary:
          "La conversación es tan monótona que hasta el reloj parece ir más lento.",
        aiRole:
        ...
        caracterPrompt:
          "A man in his early 40s wearing a beige cardigan and glasses. He has a neutral facial expression and is holding a notepad with trivia facts.",
        requirements: [
          {
      ...
      },
      {
        ...
        sceneSummary:
          "Ni siquiera han traído las bebidas y ya está hablando de los nombres de sus futuros hijos.",
        aiRole:
