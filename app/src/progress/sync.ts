...
function normalizeStoryActiveMission(
  ...
  return {
    ...
    ...(asNonEmptyString(raw.avatarImageXsUrl) ? { avatarImageXsUrl: asNonEmptyString(raw.avatarImageXsUrl) } : {}),
    ...(asNonEmptyString(raw.avatarImageMdUrl) ? { avatarImageMdUrl: asNonEmptyString(raw.avatarImageMdUrl) } : {}),
    ...(asNonEmptyString(raw.videoPreviewUrl) ? { videoPreviewUrl: asNonEmptyString(raw.videoPreviewUrl) } : {}),
    ...(asNonEmptyString(raw.videoThumbnailUrl) ? { videoThumbnailUrl: asNonEmptyString(raw.videoThumbnailUrl) } : {}),
    messages,
    requirements,
